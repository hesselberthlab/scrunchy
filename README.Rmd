...
These plots show measured DNA repair activities measured for a unmodified DNA substrate (**A**), uracil base excision (in **B**, an A:uracil base-pair), ribonucleotide excision (in **C**, a riboG:C base-pair), and abasic site repair (in **D**, abasic:C). Activity is measured by the number of incisions on a DNA repair substrate included in the droplets (log-normalized).
