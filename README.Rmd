...
scrunchy provides a bioinformatic solution for the **S**ingle-**c**ell **r**econstruction of f**unc**tional **h**eterogeneit**y** (**scrunchy**).

## Protocol

A detailed protocol for performing functional measurements in the context of 10x
Genomics single-cell mRNA sequencing experiments is available at
