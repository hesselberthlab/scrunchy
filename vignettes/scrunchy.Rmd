...
knitr::include_graphics("../man/figures/method-overview.svg")
```

## Overview 

scrunchy facilitates the analysis and visualization of functional data from single cells in concert with their transcriptional profiles.
...
A `FunctionalSingleCellExperiment` in turn contains one or more objects of class [`SingleCellExperiment`], which contain observations and derived measurements that are linked by barcodes attached during sample work-up.
